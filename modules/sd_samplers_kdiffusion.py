...
def sample_dpmpp_2m_alt(model, x, sigmas, extra_args=None, callback=None, disable=None):
    ...
    for i in trange(len(sigmas) - 1, disable=disable):
        ...
        if old_denoised is None or sigmas[i + 1] == 0:
            ...
            x = (sigma_fn(t_next) / sigma_fn(t)) * x - (-h_last).expm1() * denoised_d
...
samplers_data_k_diffusion.insert(16, sd_samplers_common.SamplerData('DPM++ 2M Alt Karras', lambda model: KDiffusionSampler('sample_dpmpp_2m_alt', model), ['k_dpmpp_2m_alt_ka'], {'scheduler': 'karras'}))
